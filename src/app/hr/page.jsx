          ...
          <CardContent className="p-6 md:p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div className="md:col-span-2 space-y-2">
                    <label htmlFor="company" className='text-[#1E3161] font-semibold'>Company</label>
                    <SelectComponent
                        // defaultValue={"employee"}
                        itemList={companies}
                        className={"w-full border-2 roboto"}
                        ...
                        />
                    {errors.company_id && (
                        <p className="text-red-800 text-sm font-semibold roboto">{errors.company_id.message}</p>
                    )}

                </div>

                <div className="space-y-2">
                    <label htmlFor="patientFirstName" className='text-[#1E3161] font-semibold'>Patient First Name</label>
                    <input
                      type="text"
                      id="patientFirstName"
                    ...
                    {errors.patientFirstName && (
                        <p className="text-red-800 text-sm font-semibold roboto">{errors.patientFirstName.message}</p>
                    )}
                </div>

                <div className="space-y-2">
                    <label htmlFor="patientLastName" className='text-[#1E3161] font-semibold'>Patient Last Name</label>
                    <input
                      type="text"
                      id="patientLastName"
                      className="border border-black/30 w-full py-1 px-2 rounded-lg outline-[#1E3161] roboto"
                    ...
                    {errors.patientLastName && (
                        <p className="text-red-800 text-sm font-semibold roboto">{errors.patientLastName.message}</p>
                    )}
                </div>

                <div className="md:col-span-2">
                    <Label label={"Chief Complaint"} htmlFor={"chiefComplaint"} />
                    <textarea
                    id="chiefComplaint"
