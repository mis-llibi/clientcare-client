      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-2">
          <div>
            <Label
              label={
                "Attach your Doctor’s Request for Laboratory (with Diagnosis)"
              }
            />
            <FileUpload
              control={control}
              ...
              {fileArray.map((item, i) => (
                ...
                >
                  <div className="flex gap-2 items-center min-w-0">
                    <div>
                      <FaFileAlt className="text-[#1E3161]" />
                    </div>
          ...
          <h1 className="text-[10px] font-bold roboto ">
            If you want to be notified on the status of your LOA Request, please
          ...
          {loading ? (
            ...
            <>
              ...
              <Link
                href={`${applink}/provider/${provider_id}/laboratory`}
