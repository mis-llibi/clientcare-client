...
function Consultation() {
  ...
  const { submitRequestConsultation, searchComplaints } =
    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-5 flex flex-col gap-3">
          <h1 className="text-[#1E3161] font-bold roboto text-lg text-center">
              ...
              >
                <div className="basis-1/2 text-sm">
                  <p className="font-bold mb-1">
                    Hospital / Clinic:{" "}
                    <span className="font-normal">{selectedHospital.name}</span>
                  </p>
                  <p className="font-bold mb-1">
                    Address:{" "}
                  ...
                  <p className="font-bold mb-1">
                    City:{" "}
                    <span className="font-normal">{selectedHospital.city}</span>
                  </p>
                  <p className="font-bold mb-1">
                    State:{" "}
                    <span className="font-normal">
