...
function RequestLoa() {
  ...
  return (
    <>
      {step === "terms" && (
        <TermsOfUse device="desktop" onAccept={() => setStep("notification")} />
      )}
      ...
      {step === "main" && (
        <Card>
          <div className="w-full flex gap-2">
            <div className="border border-black/30 shadow-[2px_2px_4px_0px_rgba(0,0,0,0.25)] rounded-lg hidden lg:block w-1/3 bg-contain bg-repeat">
